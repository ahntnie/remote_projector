...
class TimeRangePicker extends StatefulWidget {
  ...
  const TimeRangePicker({
    ...
    this.tabToText = "Đến",
    this.cancelText = "Hủy",
    this.nextText = "Tiếp tục",
    this.backText = "Quay lại",
    this.selectText = "Xác nhận",
    this.selectedTimeStyle =
        const TextStyle(color: AppColor.navSelected, fontSize: 30),
    this.unselectedTimeStyle =
        const TextStyle(color: Color(0xFFBDBDBD), fontSize: 13),
    this.timeContainerStyle,
    this.editable = true,
    this.is24Format = true,
    this.activeBgColor = AppColor.navSelected,
    ...
    this.activeLabelColor = AppColor.navSelected,
    this.inactiveLabelColor = Colors.grey,
    this.indicatorColor = AppColor.navSelected,
  });
                          ...
                          widget.is24Format
                              ...
                              : Padding(
                                  ...
                                  child: ToggleSwitch(
                                    ...
                                    onToggle: (index) => fromIndex = index ?? 0,
                                  ),
                                ),
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(':', style: widget.separatorStyle),
                              ),
                              Expanded(
                                child: Container(
                                  decoration: widget.timeContainerStyle ??
                          ...
                          widget.is24Format
                              ...
                              : Padding(
                                  ...
                                  child: ToggleSwitch(
                                    ...
                                    onToggle: (index) => toIndex = index ?? 0,
                                  ),
                                ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  if (_selectedTab == 0) {
                    ...
                    if (isEdit[0]) {
                      if (textControllers[0].text.isNotEmpty) {
                        if (int.parse(textControllers[0].text) > _maxJamValue) {
                          _jamFrom = _maxJamValue;
                        } else {
                    ...
                    if (isEdit[2]) {
                      if (textControllers[2].text.isNotEmpty) {
                        if (int.parse(textControllers[2].text) > _maxJamValue) {
                          _jamTo = _maxJamValue;
                        } else {
